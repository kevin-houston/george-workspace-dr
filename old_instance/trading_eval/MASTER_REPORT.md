...
Date: 2026-04-11 (updated with R28 PEAD Quality, R29 Pairs, R31 Text PEAD, R32 Put-Writing)
...
Total backtests: ~7,200+ across all categories
...
|------|----------------------------------|------------------|---------|----------|-----------|------------------------------------------------|
| 1    | ⭐ R28 PEAD Full (quality filter) | PEAD/NLP         | +9.028  | 27.6%    | -16.9%    | EarningsQuality filter, NOR amplifier, RegimeGuard. NEW #1 |
| 2    | Div Raise >=10% hold-40d (R27)   | Dividend         | +4.403  | ~15%     | N/A       | Dividend PEAD effect                           |
| 3    | R28 Hard Filter (score>=50)      | PEAD/NLP         | +8.837  | 26.5%    | -17.0%    | 54% of signals filtered out                    |
| 4    | R28 Full + VIX-Kelly             | PEAD/NLP         | +9.021  | 26.5%    | -15.7%    | Best max DD control                            |
| 5    | Div Raise >=5% hold-40d (R27)    | Dividend         | +3.400  | ~12%     | N/A       | More signals, still strong                     |
| 6    | Bull Put Spread XOM (R28 opts)   | Options          | +2.584  | N/A      | N/A       | IV rank filter, defined-risk                   |
| 7    | Bull Put Spread CVX (R28 opts)   | Options          | +2.470  | N/A      | N/A       | Energy sector defined-risk                     |
| 8    | CC around Ex-Div 10d (R27)       | Dividend+Opts    | +2.643  | ~9%      | N/A       | Sell calls pre-ex-div                          |
| 9    | PEAD Portfolio (baseline)        | PEAD             | +2.394  | ~38%     | -26.9%    | 30-stock equal-weight gap signals              |
| 10   | SOL 20d Momentum                 | Crypto           | +1.682  | 205.8%   | -71.4%    | High CAGR, extreme drawdown                    |
| 11   | RF on XOM (best ML)              | ML               | +1.744  | N/A      | N/A       | Random Forest, walk-forward                    |
| 12   | ⭐ R29 Pairs v1 (residualized)    | Stat Arb         | +1.380  | 10.6%    | -8.4%     | Factor residualization is key driver. NEW pairs record |
| 13   | Div Capture buy-3d sell+5d       | Dividend         | +1.578  | ~6%      | N/A       | Pre-ex-div momentum                            |
| 14   | Ex-Div Drift hold-20d            | Dividend         | +1.511  | ~6%      | N/A       | Post-ex-div continuation                       |
| 15   | PEAD gap5% 20d (single)          | PEAD             | +1.137  | N/A      | N/A       | 67.8% win rate, p=0.000                        |
| 16   | Corn Seasonal                    | Commodity        | +1.175  | 18.3%    | -14.2%    | Calendar-driven, low DD                        |
| 17   | Dogs of the Dow top-10           | Dividend         | +1.203* | 15.3%    | N/A       | *annual Sharpe, p=0.003                        |
| 18   | R29 Pairs v2 (OU thresholds)     | Stat Arb         | +0.914  | 8.9%     | -18.6%    | OU calibration hurts vs fixed ±2σ — notable   |
| 19   | Pairs Portfolio (R23)            | Stat Arb         | +0.964  | 6.82%    | -11.90%   | Prior pairs best; beaten by R29 v1             |
| 20   | EWC/EWA Country Pair             | International    | +0.937  | 8.91%    | -9.5%     | Canada/Australia commodity pair                |
| 21   | Risk Parity Lite                 | Multi-Asset      | +0.865  | 9.1%     | -22.28%   | SPY/TLT/GLD vol-weighted                       |
| 22   | JNJ/UNH pair (best single)       | Stat Arb         | +0.857  | 16.45%   | -30.41%   | Best individual equity pair                    |
| 23   | VIX Short Put (R28 opts)         | Options          | +0.846  | N/A      | N/A       | 88.6% WR, structural vol floor                 |
| 24   | ML Ensemble avg                  | ML               | +0.527  | N/A      | N/A       | Beats B&H 25% of stocks                        |
| 25   | ETF Macro Overlay                | ETF Rotation     | +0.753  | 12.4%    | -18.3%    | Oil/energy + macro signal                      |
| 26   | EWT Taiwan (best intl long)      | International    | +0.615  | 11.08%   | N/A       | Semiconductor dominance                        |
| 27   | OilMom_10_50 (R18)               | Equity Macro     | +0.640  | 8.2%     | -28.0%    | Oil regime × equity strategy                   |
| 28   | Dual Momentum (ETF)              | ETF Rotation     | +0.628  | 10.8%    | -21.4%    | Absolute + relative mom                        |
| 29   | Covered Calls IBM (R25)          | Options          | +0.836  | ~9.2%    | -16.1%    | Best static CC strategy                        |
| 30   | GoldFlight_120 (R16)             | Equity Macro     | +0.559  | 18.1%    | -38.0%    | Gold regime filter on equities                 |
| 31   | Pre-Holiday Effect               | Seasonal         | +0.553  | ~4%      | -8.2%     | Only stat-sig seasonal (p=0.042)               |
| 32   | Covered Calls avg (R25)          | Options          | +0.533  | ~6-8%    | ~-18%     | Across Fortune 100 dividend stocks             |
| 33   | Iron Condor avg (R28 opts)       | Options          | +0.523  | N/A      | N/A       | IV rank>50%, 62.8% WR                          |
| 34   | VIX Mean Reversion               | Volatility       | +0.483  | 6.3%     | -19.1%    | Short VIX after spikes                         |
| 35   | VRP Harvest filtered (R28 opts)  | Options          | +0.499  | N/A      | N/A       | IV rank filter critical                        |
| 36   | Inflation Protection             | Fixed Income     | +0.462  | 5.1%     | -11.3%    | TIP/IEF rotation, SPY corr -0.12              |
| 37   | Gamma Scalping avg (R28 opts)    | Options          | +0.413  | N/A      | N/A       | Works; complex operationally                   |
| 38   | Lev Momentum UPRO/IEF            | Leveraged ETF    | +0.422  | 8.9%     | -52.5%    | SPY > 50d MA: hold UPRO else IEF              |
| 39   | Momentum Factor 6-1              | Factor           | +0.357  | 5.8%     | -24.1%    | Classic factor, alive but dim                  |
| 40   | Wheel Strategy avg (R28 opts)    | Options          | +0.312  | N/A      | N/A       | -0.130/yr vs BH; skip on growth               |
| 41   | Bull Put Spread avg (R28 opts)   | Options          | +0.744  | N/A      | N/A       | Best avg across 30 tickers                     |
| 42   | RSI Tight Forex (R2)             | Forex            | +0.280  | 0.59%    | -6.0%     | Best forex. Low CAGR unlevered                 |
| 43   | Mean Rev 40-day Forex (R1)       | Forex            | +0.200  | 0.93%    | -7.1%     | Z-score reversion, EUR/GBP                     |
| 44   | R29 Pairs baseline (raw)         | Stat Arb         | +0.436  | 3.3%     | -9.7%     | Raw returns, no residualization                |
| 45   | R32 VIX-Kelly Put-Writing        | Options          | +0.168  | 0.1%     | -0.6%     | VRP thin on broad index; use as sizing overlay |
| 13   | ⭐ R31 Text PEAD + 3d Confirm     | PEAD/NLP         | +1.322  | ~est.20% | N/A       | EPS text + 3-day confirmation. Portfolio Sharpe est. ~2.8–3.1 |
