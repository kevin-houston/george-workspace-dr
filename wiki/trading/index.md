---
updated: 2026-07-02 (low-volatility-etf-rotation.md new — H354 CONFIRMED: pure 12m top-1 OOS 1.735 USMV/SPLV/XLU/SPHD/EFAV/EEMV/ACWV 0 neg years 2022+7%; fixed-income-bond-rotation.md updated H355 CONFIRMED OB filter 1.112→1.522 MaxDD halved; smart-money-concepts-ict.md updated H346+H355 OB filter universality across stocks/equity ETFs/bond ETFs same params window=20 swing=3)
status: active
...
- [Algorithms](algorithms/) — trading strategy catalog
  ...
  - [Fixed Income / Bond ETF Rotation](algorithms/fixed-income-bond-rotation.md) ← updated 2026-07-02 (H045 PRODUCTION 21% portfolio; 13-ETF universe SHY/HYG/IEI/TIP/IEF/TLT/BIL + 6 more; 3m+6m+12m rank ensemble; OOS Sharpe 1.351 MaxDD -6.3%; carry FAILS — ETF dividends ≠ forward carry; 2022 rate shock survived via TSMOM filter; H355 CONFIRMED OB filter 1.112→1.522 MaxDD halved to -5.0%; H314/H315 NOT CONFIRMED)
  ...
  - [Smart Money Concepts (ICT) — Order Blocks, FVGs, BOS/CHoCH](algorithms/smart-money-concepts-ict.md) ← updated 2026-07-02 (H343/H344/H345 CONFIRMED + H346 CONFIRMED OOS 3.238 canonical split + H355 CONFIRMED OOS 1.522 bond ETFs; OB universality: same window=20/swing=3 best params across stocks/equity ETFs/bond ETFs; cross-asset summary table; H356 proposed for low-vol ETF universe)
  - [Low-Volatility Factor ETF Rotation](algorithms/low-volatility-etf-rotation.md) ← new 2026-07-02 (H354 CONFIRMED Var C pure 12m OOS 1.735 MaxDD -11.3% 0 neg years; USMV/SPLV/XLU/SPHD/EFAV/EEMV/ACWV; 2022 +7% vs SPY -24% via SPHD energy tilt; why pure 12m beats dual-rank on homogeneous low-vol universe; H306 NOT CONFIRMED contrast; Corr(SPY)=0.854 limits blend; H356 OB filter extension queued)
