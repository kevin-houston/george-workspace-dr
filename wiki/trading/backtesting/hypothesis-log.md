...
h168_status: IN-PROGRESS (2026-05-06, v2) — PEAD Speaker-Weighted FinBERT: run_h168.py WRITTEN + updated. Data: AlphaVantage EARNINGS_CALL_TRANSCRIPT API (25 req/day free tier). AV format: speaker-segmented JSON {speaker, title, content, sentiment}. Weights: Analyst 49%, CFO 30%, Executive 16%, Other 5% (arXiv:2604.13260 Table 4). SCRIPT UPDATES (2026-05-05): (1) GAP_THRESH changed 0.05→0.03 to match H163 (~203 expected events vs 101 at 5%); (2) earnings calendar filter added via yfinance earnings_dates (covers April 2020+; ~12% IS events in Jan-Mar 2020 will be missed); (3) rate-limit sentinel bug fixed — no longer saves [] sentinel on rate-limit hit, uses global _AV_RATE_LIMITED flag to stop pass cleanly. TRANSCRIPT CACHE STATUS: 22 files cached total; only 1 of 224 filtered-universe events has a cached transcript. Q4-2019 era downloads from pass 1 are retained but unused. DOWNLOAD PASSES: Pass 1 (2026-05-05 00:05 UTC, 22 fetches) = 22 Q4 2019 transcripts. Pass 2 (2026-05-05 00:17 UTC) = rate-limited immediately (quota exhausted by pass 1). Pass 3 (2026-05-06 00:15 UTC) = rate-limited on first call. Pass 4 (2026-05-06 02:00 UTC) = rate-limited on first call. AV QUOTA RESET FINDING: quota does NOT reset at 00:00 UTC — appears to be a rolling 24-hour window from when pass 1 ran (~00:05–00:17 UTC May 5). Reset expected around 00:17 UTC May 7 at earliest. NEXT PASS scheduled: 2026-05-07 00:30 UTC. First valid events in filtered universe: TSLA 2020-07-23, AMD 2020-07-24, QCOM 2020-07-30, AAPL 2020-07-31, AMZN 2020-07-31 (Q2 2020 earnings). BLOCKERS: (1) AV 25/day rolling window → ~9 days to download 224 events; (2) if AV pace too slow, pivot to H171 (GPT-4o-mini, $0.48 total for all 203 events, no daily quota). Script: backtesting/daily/run_h168.py.
