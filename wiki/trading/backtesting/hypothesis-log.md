...
h159_status: QUEUED — PEAD (Post-Earnings Announcement Drift): stock gaps up >5% at market open vs prior close (proxy for positive earnings surprise) → enter at open, hold 20 trading days, equal-weight. Universe: 30 large-cap stocks (AAPL, MSFT, GOOGL, META, AMZN, NVDA, TSLA, JPM, BAC, WFC, JNJ, PFE, MRK, XOM, CVX, WMT, COST, HD, LOW, SBUX, V, MA, UNH, ABBV, LLY, AVGO, AMD, QCOM, INTC, IBM). Data: yfinance daily OHLCV. Signal: (open - prev_close) / prev_close > 0.05. Benchmark: SPY. Based on Ernesto/R24h: Sharpe +2.394 (portfolio), 8-10 signals/month. Queued after H158 (tonight).
h158_status: QUEUED — Sector-neutral stock momentum: rank stocks within their GICS sector, hold top-N per sector. Reduces market beta and momentum crash risk. Requires broader universe. Queued after H157 (tonight).
h157_status: QUEUED — Factor ETF momentum: use 30-40 factor/style/sector ETFs as universe, apply same 12-1 signal. Bias-free, directly comparable to H026. Test if adding stock-factor momentum improves on ETF sector rotation. Tonight's session.
