...
h168_status: IN-PROGRESS (2026-05-07, v3) — PEAD Speaker-Weighted FinBERT: run_h168.py WRITTEN + updated. Data: AlphaVantage EARNINGS_CALL_TRANSCRIPT API (25 req/day free tier). AV format: speaker-segmented JSON {speaker, title, content, sentiment}. Weights: Analyst 49%, CFO 30%, Executive 16%, Other 5% (arXiv:2604.13260 Table 4). TRANSCRIPT CACHE STATUS: 45 files cached total; ~23/224 filtered-universe events covered (10.3%). Cache spans 2019Q4–2021Q1. DOWNLOAD PASSES: Pass 1 (2026-05-05 00:05 UTC, 22 fetches) = 22 Q4-2019 transcripts. Pass 2 (2026-05-05 00:17 UTC) = rate-limited (quota exhausted). Pass 3 (2026-05-06 00:15 UTC) = rate-limited. Pass 4 (2026-05-06 02:00 UTC) = rate-limited. Pass 5 (2026-05-07 ~00:30 UTC) = SUCCESS: 22 new transcripts fetched (LOW, WMT, AVGO, WFC, IBM, TSLA, AMD, SBUX, QCOM, META, AMZN, AAPL, GOOGL, ABBV Q2-Q3 2020; AMD, MA, QCOM, NVDA, AVGO Q4-2020; GOOGL, META, WMT Q1-2021). AV QUOTA: rolling 24h window confirmed — passes 3+4 failed because AV resets ~00:17 UTC (when pass 1 started). PACE: 22 events/pass, 1 pass/day → 4 more passes to reach 50% (112/224 events). ETA: ~2026-05-11 at current pace. NEXT PASS: 2026-05-08 00:30 UTC. BLOCKERS: (1) AV 25/day rolling window (manageable — pace to 50% in ~4 days); (2) H171/H176 both waiting on ≥50% coverage. Script: backtesting/daily/run_h168.py.
